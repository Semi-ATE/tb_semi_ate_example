...
If you have the need to add things, add it to 'bench_with_inputparameter.py' or 'common.py'
...
class bench_with_inputparameter_OP:
    """Class definition for the output parameters of bench_with_inputparameter."""

    def __init__(self):
        self.num_outputs = 0
        self.Vout = OutputParameter('Vout', -inf, nan, 0.0, nan, inf, 0, False)
...
class bench_with_inputparameter_IP:
    """Class definition for the input parameters of bench_with_inputparameter."""
...
class bench_with_inputparameter_BC(DutTestCaseBase):
    '''Base class definition for bench_with_inputparameter'''
    ...
    def __init__(self, instance_name: str, sbin, test_num, context, stil_tool: StilToolBase):
        ...
        self.ip = bench_with_inputparameter_IP()
        self.op = bench_with_inputparameter_OP()
